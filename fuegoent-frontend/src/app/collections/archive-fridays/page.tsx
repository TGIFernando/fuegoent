...
const slideshowImages = [
  { src: "/images/archive/archive-1.jpg", alt: "Archive Fridays" },
  { src: "/images/archive/archive-2.jpg", alt: "Archive Fridays" },
  { src: "/images/archive/archive-3.webp", alt: "Archive Fridays" },
  { src: "/images/archive/archive-4.jpg", alt: "Archive Fridays" },
  { src: "/images/archive/archive-5.jpg", alt: "Archive Fridays" },
];
...
export default function ArchiveFridaysPage() {
  return (
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <span className="flex items-center gap-2 text-white/60 text-sm tracking-wide">
              ...
              21+ Every Friday · 10pm – 1:30AM
            </span>
          </div>

          {/* Instagram */}
          <a
            href="https://www.instagram.com/archivefridays/"
            target="_blank"
