...
const slideshowImages = [
  { src: "/images/traviesa/traviesa-1.jpg", alt: "Traviesa Saturdays" },
  { src: "/images/traviesa/traviesa-2.jpg", alt: "Traviesa Saturdays" },
  { src: "/images/traviesa/traviesa-3.jpg", alt: "Traviesa Saturdays" },
  { src: "/images/traviesa/traviesa-4.jpg", alt: "Traviesa Saturdays" },
];
...
export default function TraviesaSaturdaysPage() {
  return (
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <span className="flex items-center gap-2 text-white/60 text-sm tracking-wide">
              ...
              21+ Every Saturday · 9:30pm – 1:30AM
            </span>
          </div>

          <p className="text-white/50 text-sm tracking-wide mb-6">
            Traviesa Saturdays Guestlist Link Down Below
          </p>

          {/* Instagram */}
          <a
            href="https://www.instagram.com/traviesasaturdays/"
            target="_blank"
